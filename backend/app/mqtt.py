...
class MQTT:
    ...
    sub_topics = [("620163595_pub", 0), ("620163595", 0), ("620163595_sub", 0)] #  A list of tuples of (topic, qos). Both topic and qos must be present in the tuple.
    ...
    def __init__(self,mongo):
        ...
        self.client.message_callback_add("620163595", self.update)
        self.client.message_callback_add("620163595_pub", self.toggle)
